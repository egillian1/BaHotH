## Flask installation and run server

* Create virtual environment using `virtualenv venv` in root folder
* Access virtualenv with `. venv/bin/activate`
* Run `sudo pip install Flask`

To run server, do the following:

* Run virtual environment with `. venv/bin/activate`
* Navigate to server folder and run `export FLASK_APP=app.py` and run `flask run`
